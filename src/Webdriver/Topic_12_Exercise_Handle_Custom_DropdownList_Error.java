...
public class Topic_12_Exercise_Handle_Custom_DropdownList_Error {
	WebDriver driver;
 ...
 @Test
	...
	public void Select_item_in_DropDown(String item_element, String list_item, String text_item) 
	{
		 ...
		 driver.get("https://jqueryui.com/resources/demos/selectmenu/default.html");
			...
			driver.findElement(By.cssSelector(item_element)).click();
			
			// 2 - Chờ cho tất cả item được load ra thành công :

			///locator phải lấy được tất cả các thành phần bên trong 
			
			exliciWait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector(list_item)));
			
			 
			/// Đưa hết tất cả các item trong dropdown vào 1 cái list 
			
			List <WebElement> speed_Drop_down_item= driver.findElements(By.cssSelector(list_item));
